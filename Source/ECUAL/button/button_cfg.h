...
#define HAZARD_BUTTON_PORT		PORTD_ID
#define HAZARD_BUTTON_PIN		PIN2_ID
/*---------------------------------------*/
#define LEFT_INDEICATOR_ID		1
#define LEFT_INDEICATOR_PORT	PORTA_ID
#define LEFT_INDEICATOR_PIN		PIN0_ID
/*---------------------------------------*/
#define RIGHT_INDEICATOR_ID		2
#define RIGHT_INDEICATOR_PORT	PORTA_ID
#define RIGHT_INDEICATOR_PIN	PIN2_ID
/*---------------------------------------*/
#define IGNITION_BUTTON_ID		3
#define IGNITION_BUTTON_PORT	PORTA_ID
#define IGNITION_BUTTON_PIN		PIN4_ID
